...
#| fig-cap: "Simulated outcomes $y=\\sin(1.4x)+0.25x+\\varepsilon$ (gray points), a single deep-tree fit (red line, left panel), and a 300-tree random-forest fit (blue line, right panel). Both models use the same 180 training observations."
#| echo: true
