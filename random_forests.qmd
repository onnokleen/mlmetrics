...
- **Impurity-based importance**: sum the reduction in the split criterion, such as RSS or Gini impurity (both defined in @sec-decision-trees), attributed to each predictor across all trees.
