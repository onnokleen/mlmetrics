...
5. **How many trees are enough?** Using Parts 2 and 4, show that
   $$
   \frac{\mathbb{V}[\bar T_B]}{\mathbb{V}[\bar T_\infty]} = 1 + \frac{1-\rho}{\rho B},
   $$
...
$$
\frac{\mathbb{V}[\bar T_B]}{\mathbb{V}[\bar T_\infty]}
=
...
$$
\mathbb{V}\big[\text{forest}\big] = \sigma^2\left[\rho + \frac{1-\rho}{B}\right],
\qquad
\mathbb{V}\big[\text{OOB}\big] = \sigma^2\left[\rho + \frac{1-\rho}{B/e}\right].
$$
