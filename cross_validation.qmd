...
For econometricians, this is not just a machine-learning issue. It arises whenever we choose among many specifications, tune regularization parameters, or compare forecasting models using the same dataset repeatedly. The repeated-use problem is the same reason nested validation is emphasized in model-selection studies such as @VarmaSimon2006 and @CawleyTalbot2010.
