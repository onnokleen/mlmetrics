...
The notation here matches the single-hidden-layer representation introduced above. The same result extends from scalar $x$ to vector-valued $\mathbf{x} \in \mathbb{R}^k$, and related formulations cover common unbounded activations such as ReLU.
