...
A function is **convex** if its Hessian is positive semidefinite everywhere. For neural networks, the Hessian is generally **not** positive semidefinite, making the optimization problem **non-convex**.
