...
The activation condition matters. The Cybenko-Hornik statement quoted here is the classical bounded-activation theorem, with sigmoids as the leading example. Modern networks often use ReLU, which is unbounded and therefore covered by related but distinct universal-approximation results. The practical lesson is the same -- width can approximate rich nonlinear functions on compact domains -- but the theorem being invoked is not literally the same theorem for every activation family.
