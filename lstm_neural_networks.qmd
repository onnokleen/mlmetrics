...
| **Parameters (recurrent cell)** | $H(H+D) + H$                                                    | $4H(H+D) + 4H$ (four weight blocks, $\approx 4\times$ the RNN cell)     |
