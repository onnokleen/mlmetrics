...
To see how LSTMs are used in current econometric research, consider the asset-pricing framework of @ChenPelgerZhu2024.
...
The authors take a final step to enforce the no-arbitrage constraint by using a Generative Adversarial Network (GAN) framework, which adjusts the training objective beyond MSE to penalize pricing errors that violate no-arbitrage. We do not cover GANs in class.
