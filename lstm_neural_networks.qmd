...
**From prediction to a no-arbitrage objective.** @ChenPelgerZhu2024 take a deliberately different route. Rather than forecasting returns, they estimate the SDF $M_{t+1}$ directly, and they replace the MSE objective with the no-arbitrage moment conditions that define the SDF:
$$
