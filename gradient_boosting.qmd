...
The general gradient boosting framework unifies algorithms that were developed independently. AdaBoost, introduced by @FreundSchapire1997 before the gradient boosting connection was made explicit, can be recovered as a special case by choosing exponential loss.
