...
Since the first term is constant with respect to $\theta$, minimizing the empirical KL expression is equivalent to maximizing the log-likelihood; see also [our discussion in Section 3](evaluating_distributions.qmd#deep-dive-connection-to-information-theory).
