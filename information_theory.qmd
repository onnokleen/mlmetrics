...
For a discrete empirical distribution, the same algebra can be written as a KL divergence between the empirical distribution $\hat{p}_{\text{data}}$ and the model distribution $p_\theta$:
