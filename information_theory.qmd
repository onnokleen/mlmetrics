...
Let $y=g(x)$ be continuously differentiable and strictly monotone, so the inverse $x=g^{-1}(y)$ exists and is differentiable. The probability densities for the new variable $y$ are given by:
$$
