...
- **Coverage of the local examples**: `SPY_daily_measures.csv` runs from 2015-01-02 through 2025-12-31; `SPY_5min_daily_rv.parquet` runs from 2015-01-02 through 2024-12-31. Rebuilt files can differ because the scripts accept user-supplied date ranges.
