...
- **Coverage of the local examples**: Both `SPY_daily_measures.csv` and `SPY_5min_daily_rv.parquet` run from 2015-01-02 through 2024-12-31. Rebuilt files can differ because the scripts accept user-supplied date ranges.
...
**Daily CSV** (`SPY_daily_measures.csv`) — used by the neural-network illustration chapters:
