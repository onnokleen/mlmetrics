...
**Only a point prediction.** A standard regression forest estimates something like $\mathbb{E}[Y\mid X=x]$. It does not directly report tail probabilities, quantiles, skewness, or multimodality of $Y\mid X=x$.
