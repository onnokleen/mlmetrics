...
\node (inputgate) at (5,  -4) {\small ``RNN-like'' Direct Flow of Input to $h_t$ };
\node (inputgate) at (6.6,  -1.2) {\small Flow $C_t$ to $h_t$};
...
\node[above right=0.1cm and 0.3cm of f] {$f_t$};
\node[right=0.1cm of i] {$i_t$};
\node[right=0.1cm of g] {$\tilde{C}_t$};
\node[right=0.1cm of o] {$o_t$};
