...
$$
\begin{aligned}
\mathbb{E}_{G, q_\theta}[\tilde r] - \mathbb{E}_F[r]
&= \underbrace{\int \mathbb{E}_{q_\theta}[\tilde r \mid \theta]
   \bigl(dG(\theta) - dF_\theta(\theta)\bigr)}_{\text{persona-mismatch bias}} \\
&\quad + \underbrace{\int \bigl(\mathbb{E}_{q_\theta}[\tilde r \mid \theta]
   - \mathbb{E}_F[r \mid \theta]\bigr) dF_\theta(\theta)}_{\text{conditional bias}}.
\end{aligned}
$$ {#eq-fm-biasdecomp}
