...
@fig-hyperband-brackets shows how these brackets differ. The wide bracket starts with many configurations and a very small budget, while the deep bracket starts with fewer configurations but allocates more resources immediately. Hyperband is attractive because it does not commit to a single breadth-versus-depth tradeoff in advance.
