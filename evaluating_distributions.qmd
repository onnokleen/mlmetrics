...
4. Explain in two or three sentences why serially correlated score differentials arise naturally in forecast evaluation — for example with multi-step or overlapping forecast targets — and why average-score comparisons such as those in @sec-eval-dist-empirical require a HAC-type standard error before they can be interpreted inferentially [@DieboldMariano1995; @GiacominiWhite2006].
