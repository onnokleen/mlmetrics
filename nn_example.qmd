...
$$
where $M_t$ is the number of intraday return intervals available after cleaning. Realized variance — the sum of intraday squared returns as a consistent estimator of integrated variance under standard semimartingale assumptions — is the canonical high-frequency volatility measure introduced by @AndersenBollerslevDieboldLabys2003. It is positive, highly right-skewed, and persistent. For that reason, a common forecasting target is
$$
z_t = \log(RV_t),
$$
