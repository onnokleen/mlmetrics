...
Second, the QLIKE column in the table above is the @Patton2011 quasi-likelihood loss for volatility, the standard comparison loss in the high-frequency volatility literature. It is *robust* in Patton's sense that rankings by *expected* loss are preserved when the true variance is replaced by a conditionally unbiased proxy such as realized variance; sampling variation can still reverse the ordering of finite-sample average losses.
