...
|---|---|---:|---:|---:|---:|
| `log(rv)` | HAR-FNN | 96 | 0.000972 | 48 | 0.2809 |
| `log(rv)` | FNN | 48 | 0.000328 | 16 | 0.2763 |
| `log(rv)` | Simple RNN | 44 | 0.000180 | 28 | 0.2741 |
| `log(rv)` | LSTM | 76 | 0.000717 | 64 | 0.2718 |
| `rv` | HAR-FNN | 32 | 0.000275 | 40 | 0.0953 |
| `rv` | FNN | 48 | 0.000806 | 44 | 0.1023 |
| `rv` | Simple RNN | 44 | 0.000204 | 40 | 0.0961 |
| `rv` | LSTM | 96 | 0.000972 | 48 | 0.1014 |
...
for bars in ax_r.containers:
    ax_r.bar_label(bars, fmt="%.3f", fontsize=9)
ax_l.grid(alpha=0.3)
fig.text(0.01, 0.015,
         "Derived from local SPY realized-volatility data; see the dataset appendix. "
         "HAR-OLS and HAR-FNN use the same components (logs for the log target, levels "
         "for the level target). Recurrent models use tanh cells.",
...
\right),
$$
which is defined only for positive variance forecasts; with the same indexing convention as above, $\widehat{RV}_t$ is the forecast of $RV_t$ formed at $t-1$. All three measures are losses, so smaller values are better.

| Target fit | Model | RMSE log RV | RMSE RV | QLIKE |
|---|---|---:|---:|---:|
| `log(rv)` | HAR-OLS | 0.5992 | 0.4121 | 0.2124 |
| `log(rv)` | HAR-FNN | 0.5974 | 0.4128 | 0.2014 |
| `log(rv)` | FNN | 0.6036 | 0.4125 | 0.2059 |
| `log(rv)` | Simple RNN | 0.6461 | 0.4193 | 0.2528 |
| `log(rv)` | LSTM | 0.5997 | 0.4179 | 0.2129 |
| `rv` | HAR-OLS | 0.6755 | 0.4197 | 0.1985 |
| `rv` | HAR-FNN | 0.6642 | 0.4268 | 0.1949 |
| `rv` | FNN | 0.7467 | 0.4399 | 0.4829 |
| `rv` | Simple RNN | 0.7342 | 0.4544 | 0.2280 |
| `rv` | LSTM | 0.6355 | 0.4260 | 0.1964 |
